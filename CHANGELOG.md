...
### Added
- Deterministic v1 book manifests, cross-book catalog rebuilding, and bounded
  tag/facet/scripture/person queries.
- Security scanning for theology supporting files and `book-index.json`.
